...
(***************************************************************************)
RequestSubPrivilegeMsgs ==
  [type: {"req_sub_priv"}, seq:Nat, sender: EOp, receiver: BOp, channel: Channel]
      \cup
  [type: {"rsp_sub_priv"}, seq:Nat, sender: BOp, receiver: EOp, broker: Broker]
      \cup
  [type: {"rsp_sub_priv_f"}, seq:Nat, sender: BOp, receiver: EOp]

RequestPubPrivilegeMsgs ==
  [type: {"req_pub_priv"}, seq:Nat, sender: Exper, receiver: BOp, broker: Broker]
      \cup
  [type: {"rsp_pub_priv"}, seq:Nat, sender: BOp, receiver: Exper]
      \cup
  [type: {"rsp_pub_priv_f"}, seq:Nat, sender: BOp, receiver: Exper]

RequestExpPrivilegeMsgs ==
  [type: {"req_exp_priv"}, seq:Nat, sender: Exper, receiver: EOp, exp: Exp]
      \cup
  [type: {"rsp_exp_priv"}, seq:Nat, sender: EOp, receiver: Exper,
   broker_owner: BOp, broker: Broker, channel: Channel, exp_priv: Exp]
      \cup
  [type: {"rsp_exp_priv_f"}, seq:Nat, sender: EOp, receiver: Exper]

(***************************************************************************)
(*                       Agent interaction messages                        *)
(***************************************************************************)
RequestSubMsgs ==
  [type: {"cmd_sub"}, seq:Nat, sender: EOp, receiver: Endpoint,
   broker: Broker, channel: Channel]
      \cup
  [type: {"ack_cmd_sub"}, seq:Nat, sender: Endpoint, receiver: EOp]
      \cup
  [type: {"nack_cmd_sub"}, seq:Nat, sender: Endpoint, receiver: EOp]
      \cup
  [type: {"req_sub"}, seq:Nat, sender: Endpoint, receiver: Broker,
   owner: EOp, channel: Channel]
      \cup
  [type: {"rsp_sub"}, seq:Nat, sender: Broker, receiver: Endpoint]
      \cup
  [type: {"rsp_sub_f"}, seq:Nat, sender: Broker, receiver: Endpoint]
      \cup
  [type: {"auth_sub_req"}, seq:Nat, sender: Broker, receiver: BOp,
   origin: Endpoint, owner: EOp, channel: Channel]
      \cup
  [type: {"ack_auth_sub_req"}, seq:Nat, sender: BOp, receiver: Broker]
      \cup
  [type: {"nack_auth_sub_req"}, seq:Nat, sender: BOp, receiver: Broker]
      \cup
  [type: {"req_auth_sub_agent"}, seq:Nat, sender: BOp, receiver: EOp,
   origin: Endpoint, target: Broker, channel: Channel]
      \cup
  [type: {"rsp_auth_sub_agent"}, seq:Nat, sender: EOp, receiver: BOp]
      \cup
  [type: {"rsp_auth_sub_agent_f"}, seq:Nat, sender: EOp, receiver: BOp]

RequestPubMsgs ==
  [type: {"cmd_pub"}, seq:Nat, sender: Exper, receiver: Controller,
   exp: Exp, broker: Broker, channel: Channel, sni: SNI]
      \cup
  [type: {"ack_cmd_pub"}, seq:Nat, sender: Controller, receiver: Exper]
      \cup
  [type: {"nack_cmd_sub"}, seq:Nat, sender: Controller, receiver: Exper]
      \cup
  [type: {"req_pub"}, seq:Nat, sender: Controller, receiver: Broker,
   owner: Exper, exp: Exp, channel: Channel, sni: SNI]
      \cup
  [type: {"rsp_pub"}, seq:Nat, sender: Broker, receiver: Controller]
      \cup
  [type: {"rsp_pub_f"}, seq:Nat, sender: Broker, receiver: Controller]
      \cup
  [type: {"auth_pub_req"}, seq:Nat, sender: Broker, receiver: BOp,
   origin: Controller, owner: Exper, exp: Exp, channel: Channel, sni: SNI]
      \cup
  [type: {"ack_auth_pub_req"}, seq:Nat, sender: BOp, receiver: Broker]
      \cup
  [type: {"nack_auth_pub_req"}, seq:Nat, sender: BOp, receiver: Broker]
      \cup
  [type: {"req_auth_pub_agent"}, seq:Nat, sender: BOp, receiver: Exper,
   origin: Controller, target: Broker, channel: Channel, exp: Exp, sni: SNI]
      \cup
  [type: {"rsp_auth_pub_agent"}, seq:Nat, sender: Exper, receiver: BOp]
      \cup
  [type: {"rsp_auth_pub_agent_f"}, seq:Nat, sender: Exper, receiver: BOp]

NotifyAndRunExpMsgs ==
  [type: {"notify_exp"}, seq:Nat, sender: Broker, receiver: Endpoint,
   target: Controller, exp: Exp, channel: Channel, sni: SNI]
      \cup
  [type: {"auth_notify"}, seq:Nat, sender: Endpoint, receiver: EOp,
   notifier: Broker, channel: Channel]
      \cup
  [type: {"ack_auth_notify"}, seq:Nat, sender: EOp, receiver: Endpoint]
      \cup
  [type: {"nack_auth_notify"}, seq:Nat, sender: EOp, receiver: Endpoint]
      \cup
  [type: {"connect"}, seq:Nat, sender: Endpoint, receiver: Controller, sni: SNI] \* for mimicing endpoint connection to controller
      \cup
  [type: {"conn_accepted"}, seq:Nat, sender: Controller, receiver: Endpoint]
      \cup
  [type: {"conn_refused"}, seq:Nat, sender: Controller, receiver: Endpoint]
      \cup
  [type: {"auth_sni"}, seq:Nat, sender: Controller, receiver: Exper, sni: SNI]
      \cup
  [type: {"ack_sni"}, seq:Nat, sender: Exper, receiver: Controller]
      \cup
  [type: {"nack_sni"}, seq:Nat, sender: Exper, receiver: Controller]
      \cup
  [type: {"req_run_exp"}, seq:Nat, sender: Controller, receiver: Endpoint,
   owner: Exper]
      \cup
  [type: {"rsp_run_exp"}, seq:Nat, sender: Endpoint, receiver: Controller]
      \cup
  [type: {"rsp_run_exp_f"}, seq:Nat, sender: Endpoint, receiver: Controller]
      \cup
  [type: {"auth_exp"}, seq:Nat, sender: Endpoint, receiver: EOp,
   origin: Controller, owner: Exper, exp: Exp, notifier: Broker, channel: Channel]
      \cup
  [type: {"ack_auth_exp"}, seq:Nat, sender: EOp, receiver: Endpoint, exp_priv: Exp]
      \cup
  [type: {"nack_auth_exp"}, seq:Nat, sender: EOp, receiver: Endpoint]
      \cup
  [type: {"req_auth_exp_agent"}, seq:Nat, sender: EOp, receiver: Exper,
   origin: Controller, exp: Exp, notifier: Broker, channel: Channel]
      \cup
  [type: {"rsp_auth_exp_agent"}, seq:Nat, sender: Exper, receiver: EOp]
      \cup
  [type: {"rsp_auth_exp_agent_f"}, seq:Nat, sender: Exper, receiver: EOp]
      \cup
  [type: {"req_help_exp"}, seq:Nat, sender: Endpoint, receiver: Controller,
   owner: EOp]
      \cup
  [type: {"rsp_help_exp"}, seq:Nat, sender: Controller, receiver: Endpoint]
      \cup
  [type: {"rsp_help_exp_f"}, seq:Nat, sender: Controller, receiver: Endpoint]
      \cup
  [type: {"auth_help"}, seq:Nat, sender: Controller, receiver: Exper,
   owner: EOp, origin: Endpoint]
      \cup
  [type: {"ack_auth_help"}, seq:Nat, sender: Exper, receiver: Controller, exp: Exp]
      \cup
  [type: {"nack_auth_help"}, seq:Nat, sender: Exper, receiver: Controller]
      \cup
  [type: {"req_auth_help_agent"}, seq:Nat, sender: Exper, receiver: EOp,
   helper: Endpoint]
      \cup
  [type: {"rsp_auth_help_agent"}, seq:Nat, sender: EOp, receiver: Exper]
      \cup
  [type: {"rsp_auth_help_agent_f"}, seq:Nat, sender: EOp, receiver: Exper]
      \cup
  [type: {"exec_exp"}, seq:Nat, sender: Controller, receiver: Endpoint, exp: Exp]
...
vars == <<BOpState,
          ...
          ControllerState,
          msgs>>
TrackSeqSet == SUBSET ((BOp \cup EOp \cup Exper \cup Broker \cup Endpoint \cup Controller) \X SUBSET (Nat))
...
TypeOK ==
  ...
  /\ BOpState \in [BOp -> [state: {"Idle", "AwaitAuthAgentPub", "AwaitAuthAgentSub"},
                           ...
                           sub_priv: SUBSET (EOp \X Channel \X Broker),
                           pub_priv: SUBSET (Exper \X Broker),
                           counter: Nat, track: TrackSeqSet]]
  /\ EOpState \in [EOp -> [state: {"Idle", "AwaitSubPrivilege", "AwaitSub", "AwaitAuthAgentExp"},
                           received_msg: Messages \cup {empty_msg},
                           sent_msg: Messages \cup {empty_msg},
                           sub_priv: SUBSET (BOp \X Channel \X Broker),
                           exp_priv: SUBSET (Exper \X Channel \X Broker \X Exp),
                           sub_cmd: SUBSET (Endpoint \X Channel \X Broker),
                           unused_sub_priv: SUBSET (BOp \X Channel \X Broker),
                           sub_targets: SUBSET (BOp \X Channel),
                           counter: Nat, track: TrackSeqSet]]
  /\ ExperState \in [Exper -> [state: {"Idle", "AwaitPubPrivilege", "AwaitExpPrivilege", "AwaitPub", "AwaitAuthAgentHelp"},
                               received_msg: Messages \cup {empty_msg},
                               sent_msg: Messages \cup {empty_msg},
                               pub_priv: SUBSET (BOp \X Broker),
                               exp_priv: SUBSET (EOp \X Channel \X Broker \X Exp \X Exp),
                               pub_cmd: SUBSET (Controller \X Exp \X Channel \X Broker \X SNI),
                               unused_pub_priv: SUBSET (BOp \X Broker),
                               unused_exp_priv: SUBSET (EOp \X Channel \X Broker \X Exp \X Exp),
                               run_targets: SUBSET (EOp \X Exp),
                               counter: Nat, track: TrackSeqSet]]
  \* Agent types
  /\ BrokerState \in [Broker -> [state: {"Idle", "AwaitSubAuth", "AwaitPubAuth"},
                                 received_msg: Messages \cup {empty_msg},
                                 sent_msg: Messages \cup {empty_msg},
                                 sub_info: SUBSET (Endpoint \X Channel),
                                 pub_info: SUBSET (Controller \X Exp \X Channel \X SNI),
                                 notified: SUBSET (Endpoint \X Controller \X Exp \X Channel \X SNI),
                                 counter: Nat, track: TrackSeqSet]]
  /\ EndpointState \in [Endpoint -> [state: {"Idle", "AwaitSub", "AwaitNotifyAuth", "AwaitConn", "AwaitRunExp", "AwaitExpAuth", "AwaitHelpExp", "AwaitExp"},
                                     received_msg: Messages \cup {empty_msg},
                                     sent_msg: Messages \cup {empty_msg},
                                     run_info: (Controller \X Exp) \cup {null_info},
                                     executed_exp: SUBSET (Controller \X Exp),
                                     counter: Nat, track: TrackSeqSet]]
...
BOpNegRspReqSubPriv(bo) ==
    ...
    /\ \E m \in msgs :
        ...
        /\ m.receiver = bo
        /\ UnseenSeq(BOpState[bo].track, m.sender, m.seq)
        /\ \A b \in Broker: ~ <<bo, m.sender, b>> \in BOpAllowedEOp
        /\ msgs' = msgs \cup
                     {[type |-> "rsp_sub_priv_f",
                       seq |-> m.seq,
                       sender |-> bo,
...
\* Note: potential reuse of rsp from EOp
BOpPosRspAuthSub(bo) ==
...
\* Note: potential reuse of rsp from BOp
...
\* Last modified Wed Dec 08 02:40:20 CST 2021 by User
